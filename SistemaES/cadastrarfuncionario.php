    ...
    <form action="cadastrarFuncionario.php" method="post">
      ...
      <div class="box box-warning" style="border-color:#222D32; margin-top: 20px;">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            <label>CPF</label>
            <input type="text" name="cpf" class="form-control" placeholder="Digite o CPF" maxlength="11" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label>Cargo</label>
            <input type="text" name="cargo" class="form-control" placeholder="Digite o cargo" required>
          </div>
